...
var JiraApi = function () {
  ...
  (0, _createClass3.default)(JiraApi, [{
    ...
    key: 'getValidProjectKey',
    value: function getValidProjectKey(projectKey) {
      return this.doRequest(this.makeRequestHeader(this.makeUri({
        pathname: '/projectvalidate/key',
        query: {
          key: projectKey
        }
      })));
    ...
    value: function addWorklog(issueId, worklog, newEstimate) {
      var header = {
        uri: this.makeUri({
          ...
          query: { adjustEstimate: 'new', newEstimate: newEstimate }
        }),
        body: worklog,
        method: 'POST',
